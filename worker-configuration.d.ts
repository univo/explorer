/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5c37b4df8d71196c99cf1683f437e163)
// Runtime types generated with workerd@1.20260526.1 2026-01-20 nodejs_compat
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	LOG_LEVEL: "DEBUG";
	ENVIRONMENT: "STAGING" | "PRODUCTION" | "DEVELOPMENT";
	UNIVO_SIGNING_KEY: string;
	ETHEREUM_URL: string;
	CLICKHOUSE_USERNAME: string;
	CLICKHOUSE_PASSWORD: string;
	CLICKHOUSE_URL: string;
	VERCEL_BLOB_TOKEN: string;
	OPEN_LABELS_API_KEY_ID: string;
	OPEN_LABELS_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_LEVEL" | "ENVIRONMENT" | "UNIVO_SIGNING_KEY" | "ETHEREUM_URL" | "CLICKHOUSE_USERNAME" | "CLICKHOUSE_PASSWORD" | "CLICKHOUSE_URL" | "VERCEL_BLOB_TOKEN" | "OPEN_LABELS_API_KEY_ID" | "OPEN_LABELS_API_KEY">> {}
}
