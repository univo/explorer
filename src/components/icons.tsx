...
export function SearchIcon(props: ComponentProps<"svg">) {
	return (
		<svg fill="none" strokeWidth={2.5} viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export function EtherscanIcon(props: ComponentProps<"svg">) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="123" height="123" viewBox="0 0 123 123" fill="none" {...props}>
			<path
				fill="currentColor"
...
export function ExclamationIcon(props: ComponentProps<"svg">) {
	return (
