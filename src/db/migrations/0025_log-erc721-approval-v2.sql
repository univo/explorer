CREATE TABLE "log_erc721_approval_v2" (
...
CREATE INDEX "log_erc721_approval_v2_block_timestamp_idx" ON "log_erc721_approval_v2" USING btree ("block_timestamp" DESC NULLS LAST);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "log_erc721_approval_v2" SET (
...
--> statement-breakpoint
DROP TABLE "log_erc721_approval_v1" CASCADE;
