CREATE TABLE "log_uniswap_v3_pool_created_v2" (
...
--> statement-breakpoint
CREATE INDEX "log_uniswap_v3_pool_created_v2_block_timestamp_idx" ON "log_uniswap_v3_pool_created_v2" USING btree ("block_timestamp" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "log_uniswap_v3_pool_created_v2_pool_address_idx" ON "log_uniswap_v3_pool_created_v2" USING btree ("pool_address");--> statement-breakpoint
CREATE INDEX "log_uniswap_v3_pool_created_v2_token_0_address_idx" ON "log_uniswap_v3_pool_created_v2" USING btree ("token_0_address");--> statement-breakpoint
CREATE INDEX "log_uniswap_v3_pool_created_v2_token_1_address_idx" ON "log_uniswap_v3_pool_created_v2" USING btree ("token_1_address");--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "log_uniswap_v3_pool_created_v2" SET (
...
--> statement-breakpoint
DROP MATERIALIZED VIEW "view_prices_v1";
--> statement-breakpoint
DROP TABLE "log_uniswap_v3_pool_created_v1";
--> statement-breakpoint
DROP TABLE "log_uniswap_v3_swap_v1";
--> statement-breakpoint
...
"official_swaps" AS (
	SELECT
		"swap"."chain",
		"swap"."block_timestamp" AS "observed_at",
		"swap"."block_number",
		"swap"."tx_index",
		"swap"."log_index",
		"swap"."pool_address",
	...
	FROM "log_uniswap_v3_swap_v2" AS "swap"
	INNER JOIN "log_uniswap_v3_pool_created_v2" AS "pool"
		ON "pool"."chain" = "swap"."chain"
		AND "pool"."pool_address" = "swap"."pool_address"
),
...
"ranked_pool_closes" AS (
	SELECT
		...
		row_number() OVER (
			...
			ORDER BY
				"swap"."observed_at" DESC,
				"swap"."block_number" DESC,
				"swap"."tx_index" DESC,
				"swap"."log_index" DESC
		) AS "position"
