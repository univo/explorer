...
import { event, getCancelPendingTxV3 } from "./event";
...
test.concurrent("cancel_pending_tx_v3", async ({ expect }) => {
	...
	const initial = await getCancelPendingTxV3(ids);
		...
		[
		  {
		    ...
		    "id": "5f4fc6ee00a488a000140000000001000f",
		    "nonce": "0x0118",
		    "success": true,
		  ...
		  },
		  {
		    ...
		    "id": "5f4fc6ee00a488a000170000000001000f",
		    "nonce": "0xb2",
		    "success": true,
		    "tag": "cancel_pending_tx_v3",
		  },
		  {
		    ...
		    "id": "5f4fc6ee00a488a000260000000001000f",
		    "nonce": "0x20d7",
		    "success": true,
		    "tag": "cancel_pending_tx_v3",
		  },
		  {
		    ...
		    "id": "5f4fc6ee00a488a0004b0000000001000f",
		    "nonce": "0x0b48",
		    "success": true,
		    "tag": "cancel_pending_tx_v3",
		  },
		  {
		    ...
		    "id": "5f4fc6ee00a488a000730000000001000f",
		    "nonce": "0x42",
		    "success": true,
		    "tag": "cancel_pending_tx_v3",
		  },
