...
export function Erc20TransferV1Description(props: { event: Erc20TransferV2 }) {
...
export function Erc20TransferV1AccountDescription(props: { event: Erc20TransferV2; account: IAccount }) {
	const chain = parseId(props.event.id).chain_id;
